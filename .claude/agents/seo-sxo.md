...
- Fetch the target URL using `python .claude/skills/seo/scripts/runtime.py run render_page.py "<url>" --mode auto --json` (SPA-aware SSRF-protected renderer)
- Parse with `python .claude/skills/seo/scripts/runtime.py run parse_html.py --url "<url>"` to extract SEO elements
...
- [ ] URL was fetched via .claude/skills/seo/scripts/render_page.py --mode auto (not raw curl)
