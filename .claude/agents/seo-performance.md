...
2. Use `python .claude/skills/seo/scripts/runtime.py run render_page.py <URL> --mode auto --json` before HTML/source inspection so SPA content is visible when needed
...
python .claude/skills/seo/scripts/runtime.py run pagespeed_check.py URL --json

# SPA-aware HTML/render inspection
python .claude/skills/seo/scripts/runtime.py run render_page.py URL --mode auto --json
...
```bash
python .claude/skills/seo/scripts/runtime.py run pagespeed_check.py URL --json
python .claude/skills/seo/scripts/runtime.py run crux_history.py URL --json
```
