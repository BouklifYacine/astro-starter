...
Use the screenshot script (`.claude/skills/seo/scripts/capture_screenshot.py` in the plugin root) for browser automation:

```bash
python .claude/skills/seo/scripts/runtime.py run capture_screenshot.py URL --all --output screenshots/
python .claude/skills/seo/scripts/runtime.py run render_page.py URL --mode auto --a11y-tree --json
```
