...
python .claude/skills/seo/scripts/runtime.py run iptc_ai_label.py audit ./images/ --json

# Audit a single image
python .claude/skills/seo/scripts/runtime.py run iptc_ai_label.py audit ./hero.webp --json

# Inject the AI label into an image
python .claude/skills/seo/scripts/runtime.py run iptc_ai_label.py inject ./ai-hero.webp \
