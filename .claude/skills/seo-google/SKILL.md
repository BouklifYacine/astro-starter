...
```bash
python .claude/skills/seo/scripts/runtime.py run google_auth.py --check --json
```
...
**Script:** `python .claude/skills/seo/scripts/runtime.py run pagespeed_check.py <url> --json`
...
**Script:** `python .claude/skills/seo/scripts/runtime.py run pagespeed_check.py <url> --crux-only --json`

### `/seo google crux-history <url>`

25-week CrUX History trends. Shows whether CWV metrics are improving, stable, or degrading.

**Script:** `python .claude/skills/seo/scripts/runtime.py run crux_history.py <url> --json`
**Reference:** `references/pagespeed-crux-api.md`
...
**Script:** `python .claude/skills/seo/scripts/runtime.py run gsc_query.py --property <property> --json`
...
**Script:** `python .claude/skills/seo/scripts/runtime.py run gsc_inspect.py <url> --json`
...
**Script:** `python .claude/skills/seo/scripts/runtime.py run gsc_inspect.py --batch <file> --json`
...
**Script:** `python .claude/skills/seo/scripts/runtime.py run gsc_query.py sitemaps --property <property> --json`
...
**Script:** `python .claude/skills/seo/scripts/runtime.py run indexing_notify.py <url> --json`
...
**Script:** `python .claude/skills/seo/scripts/runtime.py run indexing_notify.py --batch <file> --json`
...
**Script:** `python .claude/skills/seo/scripts/runtime.py run ga4_report.py --property <id> --json`
...
**Script:** `python .claude/skills/seo/scripts/runtime.py run ga4_report.py --property <id> --report top-pages --json`
...
**Script:** `python .claude/skills/seo/scripts/runtime.py run youtube_search.py search "<query>" --json`
...
**Script:** `python .claude/skills/seo/scripts/runtime.py run youtube_search.py video <video_id> --json`
...
**Script:** `python .claude/skills/seo/scripts/runtime.py run nlp_analyze.py --url <url> --json` or `--text "..."`
...
**Script:** `python .claude/skills/seo/scripts/runtime.py run nlp_analyze.py --url <url> --features entities --json`
...
**Script:** `python .claude/skills/seo/scripts/runtime.py run keyword_planner.py ideas "<seed>" --json`
...
**Script:** `python .claude/skills/seo/scripts/runtime.py run keyword_planner.py volume "<kw1>,<kw2>" --json`
...
**Script:** `python .claude/skills/seo/scripts/runtime.py run google_report.py --type <type> --data <json> --domain <domain> --format pdf`
...
2. Save JSON output to file: `python .claude/skills/seo/scripts/runtime.py run pagespeed_check.py <url> --json > data.json`
3. Generate report: `python .claude/skills/seo/scripts/runtime.py run google_report.py --type cwv-audit --data data.json --domain <domain>`
