...
2. Fetch page via `.claude/skills/seo/scripts/fetch_page.py`
3. Parse HTML via `.claude/skills/seo/scripts/parse_html.py`
4. Optionally fetch CWV via `.claude/skills/seo/scripts/pagespeed_check.py` (use `--skip-cwv` to skip)
5. Hash HTML body and schema content (SHA-256)
6. Store snapshot in SQLite

**Execution:**
```bash
python .claude/skills/seo/scripts/runtime.py run drift_baseline.py <url>
python .claude/skills/seo/scripts/runtime.py run drift_baseline.py <url> --skip-cwv
```
...
**Execution:**
```bash
python .claude/skills/seo/scripts/runtime.py run drift_compare.py <url>
python .claude/skills/seo/scripts/runtime.py run drift_compare.py <url> --baseline-id 5
python .claude/skills/seo/scripts/runtime.py run drift_compare.py <url> --skip-cwv
```
...
```bash
python .claude/skills/seo/scripts/runtime.py run drift_report.py <comparison_json_file> --output drift-report.html
```
...
**Execution:**
```bash
python .claude/skills/seo/scripts/runtime.py run drift_history.py <url>
python .claude/skills/seo/scripts/runtime.py run drift_history.py <url> --limit 10
```
...
- **All URL fetching** goes through `.claude/skills/seo/scripts/fetch_page.py` which enforces SSRF protection
