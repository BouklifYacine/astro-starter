...
Usage::
    ...
    python .claude/skills/seo/scripts/portability_check.py
    python .claude/skills/seo/scripts/portability_check.py --json
    python .claude/skills/seo/scripts/portability_check.py --strict   # warnings also fail
"""
