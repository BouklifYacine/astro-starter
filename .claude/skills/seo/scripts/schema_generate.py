...
Usage::
    ...
    python .claude/skills/seo/scripts/schema_generate.py reservation \\
        --provider "Marea NYC" --start 2026-06-04T19:30:00-04:00 \\
        --party-size 4 --reservation-id RX-12345

    python .claude/skills/seo/scripts/schema_generate.py order \\
        --merchant "Acme Pizza" --order-url https://acme.example/order

    python .claude/skills/seo/scripts/schema_generate.py discussion \\
        --headline "How do you score INP correctly?" \\
        --author "Sara Park" \\
        --url https://forum.example.com/t/123 \\
        --date 2026-05-12T14:00:00Z

    python .claude/skills/seo/scripts/schema_generate.py profile \\
        --name "Daniel Agrici" \\
