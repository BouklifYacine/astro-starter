...
Usage::
    ...
    python .claude/skills/seo/scripts/unlighthouse_run.py https://example.com
    python .claude/skills/seo/scripts/unlighthouse_run.py https://example.com --json
    python .claude/skills/seo/scripts/unlighthouse_run.py https://example.com --device desktop --max-routes 50
"""
