...
Usage::
    ...
    python .claude/skills/seo/scripts/seo_updates.py                  # latest 10
    python .claude/skills/seo/scripts/seo_updates.py --since 2025-06  # ISO yyyy or yyyy-mm filter
    python .claude/skills/seo/scripts/seo_updates.py --kind core
    python .claude/skills/seo/scripts/seo_updates.py --json
    python .claude/skills/seo/scripts/seo_updates.py --unverified     # show 3rd-party claims awaiting check
"""
