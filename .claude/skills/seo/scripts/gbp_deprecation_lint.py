...
Usage::
    ...
    python .claude/skills/seo/scripts/gbp_deprecation_lint.py https://example.com
    python .claude/skills/seo/scripts/gbp_deprecation_lint.py page.html --file
    python .claude/skills/seo/scripts/gbp_deprecation_lint.py https://example.com --json
