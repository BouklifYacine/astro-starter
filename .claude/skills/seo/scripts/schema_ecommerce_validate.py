...
Usage::
    ...
    cat product.json | python .claude/skills/seo/scripts/schema_ecommerce_validate.py
    python .claude/skills/seo/scripts/schema_ecommerce_validate.py product.json --eu
    python .claude/skills/seo/scripts/schema_ecommerce_validate.py product.json --json
