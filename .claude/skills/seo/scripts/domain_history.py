...
CLI::
    ...
    python .claude/skills/seo/scripts/domain_history.py example.com
    python .claude/skills/seo/scripts/domain_history.py example.com --json
    python .claude/skills/seo/scripts/domain_history.py example.com --topic crypto-signals --baseline-topic veterinary
