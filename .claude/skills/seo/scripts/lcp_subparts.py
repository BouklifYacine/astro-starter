...
Usage::
    ...
    python .claude/skills/seo/scripts/lcp_subparts.py https://example.com/
    python .claude/skills/seo/scripts/lcp_subparts.py https://example.com/ --form-factor PHONE --json

Requires the same Google API key used by ``.claude/skills/seo/scripts/crux_history.py``.
"""
    ...
    if not api_key:
        return {
            "error": "Google API key not configured. "
                     "Run `python .claude/skills/seo/scripts/google_auth.py --setup`.",
        }
