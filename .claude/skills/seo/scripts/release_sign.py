...
Generate a manifest for the current working tree::
    ...
    python .claude/skills/seo/scripts/release_sign.py > release-manifest.json

Compare two manifests to find drift between releases::

    python .claude/skills/seo/scripts/release_sign.py --compare old.json new.json
...
::

    {
      ...
      "files": {
        ".claude/skills/seo/scripts/url_safety.py": "<sha256 hex>",
        …
      },
