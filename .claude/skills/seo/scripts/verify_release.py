...
After installing from a tag::
    ...
    python .claude/skills/seo/scripts/verify_release.py path/to/release-manifest.json
...
This pairs with ``.claude/skills/seo/scripts/release_sign.py`` (used by the maintainer to
