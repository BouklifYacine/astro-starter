...
- **Script:** `.claude/skills/seo/scripts/moz_api.py`
...
- **Script:** `.claude/skills/seo/scripts/bing_webmaster.py`
...
- **Script:** `.claude/skills/seo/scripts/commoncrawl_graph.py`
...
- **Script:** `.claude/skills/seo/scripts/verify_backlinks.py`
