...
- Raw HTML + rendered HTML (via `.claude/skills/seo/scripts/render_page.py`)
...
- Core Web Vitals field data from CrUX (via `.claude/skills/seo/scripts/pagespeed_check.py`)
...
- A PDF via `.claude/skills/seo/scripts/google_report.py` when the user asks for one.
