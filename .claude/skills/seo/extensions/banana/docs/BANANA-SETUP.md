...
```bash
python .claude/skills/seo/scripts/runtime.py run --extension banana setup_mcp.py --key YOUR_KEY
```
...
```bash
python .claude/skills/seo/scripts/runtime.py run --extension banana validate_setup.py
```
