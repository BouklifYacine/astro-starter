...
|---|---|
| `/seo bing links <url>` | `python .claude/skills/seo/scripts/runtime.py run bing_webmaster.py links <url>` |
| `/seo bing compare <urlA> <urlB>` | `python .claude/skills/seo/scripts/runtime.py run bing_webmaster.py compare <urlA> <urlB>`; both properties must be registered to the API account |
| `/seo bing submit <url>` (single URL) | `python .claude/skills/seo/scripts/runtime.py run indexnow_submit.py --host ... --urls <url>` |
| `/seo bing submit-batch <file>` | `python .claude/skills/seo/scripts/runtime.py run indexnow_submit.py --host ... --urls-file <file>` |
| `/seo bing verify-indexnow` | `python .claude/skills/seo/scripts/runtime.py run indexnow_submit.py --host ... --verify-only` |
