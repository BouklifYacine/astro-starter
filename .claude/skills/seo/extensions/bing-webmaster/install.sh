...
#
# Wires the existing .claude/skills/seo/scripts/bing_webmaster.py and indexnow_submit.py into
...
PY
    ...
    echo "  python .claude/skills/seo/scripts/runtime.py run indexnow_submit.py --host example.com \\"
