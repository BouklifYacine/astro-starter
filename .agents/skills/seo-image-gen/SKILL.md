...
```bash
python3 .agents/skills/seo/scripts/presets.py list
```
...
- Log every generation: `python3 .agents/skills/seo/scripts/cost_tracker.py log --model MODEL --resolution RES --prompt "brief"`
...
| MCP unavailable | Fall back: `python3 .agents/skills/seo/scripts/generate.py --prompt "..." --aspect-ratio "16:9"` |
