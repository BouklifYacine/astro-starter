...
Configure with: `python .agents/skills/seo/scripts/dataforseo_costs.py config --mode threshold --threshold 0.50 --daily-limit 10.00`
...
1. Run `python .agents/skills/seo/scripts/dataforseo_costs.py check <endpoint> [--count N]`
...
5. After call completes, log: `python .agents/skills/seo/scripts/dataforseo_costs.py log <endpoint> <cost>`
