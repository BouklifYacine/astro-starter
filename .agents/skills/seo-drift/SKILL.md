...
2. Fetch page via `.agents/skills/seo/scripts/fetch_page.py`
3. Parse HTML via `.agents/skills/seo/scripts/parse_html.py`
4. Optionally fetch CWV via `.agents/skills/seo/scripts/pagespeed_check.py` (use `--skip-cwv` to skip)
5. Hash HTML body and schema content (SHA-256)
6. Store snapshot in SQLite

**Execution:**
```bash
python .agents/skills/seo/scripts/drift_baseline.py <url>
python .agents/skills/seo/scripts/drift_baseline.py <url> --skip-cwv
```
...
**Execution:**
```bash
python .agents/skills/seo/scripts/drift_compare.py <url>
python .agents/skills/seo/scripts/drift_compare.py <url> --baseline-id 5
python .agents/skills/seo/scripts/drift_compare.py <url> --skip-cwv
```
...
```bash
python .agents/skills/seo/scripts/drift_report.py <comparison_json_file> --output drift-report.html
```
...
**Execution:**
```bash
python .agents/skills/seo/scripts/drift_history.py <url>
python .agents/skills/seo/scripts/drift_history.py <url> --limit 10
```
...
- **All URL fetching** goes through `.agents/skills/seo/scripts/fetch_page.py` which enforces SSRF protection
