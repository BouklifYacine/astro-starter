...
```
1. python .agents/skills/seo/scripts/fetch_page.py <url>         → raw HTML
2. python .agents/skills/seo/scripts/parse_html.py --url <url>   → SEO elements
...
```bash
python .agents/skills/seo/scripts/dataforseo_costs.py check merchant_google_products_search
```
...
After each call:
```bash
python .agents/skills/seo/scripts/dataforseo_costs.py log merchant_google_products_search <cost>
```
...
python .agents/skills/seo/scripts/dataforseo_merchant.py search "<keyword>" --marketplace google

# Seller analysis: merchant ratings and dominance
python .agents/skills/seo/scripts/dataforseo_merchant.py sellers "<keyword>"

# Normalize results for analysis
python .agents/skills/seo/scripts/dataforseo_normalize.py results.json --module merchant
```
...
```bash
python .agents/skills/seo/scripts/dataforseo_costs.py check merchant_amazon_products_search
```
...
python .agents/skills/seo/scripts/dataforseo_merchant.py search "<keyword>" --marketplace amazon

# Cross-marketplace comparison
python .agents/skills/seo/scripts/dataforseo_merchant.py compare "<keyword>"
```
