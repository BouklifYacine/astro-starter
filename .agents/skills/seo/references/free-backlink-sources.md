...
- **Script:** `.agents/skills/seo/scripts/moz_api.py`
...
- **Script:** `.agents/skills/seo/scripts/bing_webmaster.py`
...
- **Script:** `.agents/skills/seo/scripts/commoncrawl_graph.py`
- **Cache:** `~/.cache/codex-seo/commoncrawl/` (90-day TTL)
...
- **Script:** `.agents/skills/seo/scripts/verify_backlinks.py`
