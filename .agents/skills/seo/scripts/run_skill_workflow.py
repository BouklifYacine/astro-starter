...
Usage:
    python .agents/skills/seo/scripts/run_skill_workflow.py --skill seo-content https://example.com --json
"""
...
def run_specialist(skill: str, target: str, output_root: Path | None = None) -> dict[str, Any]:
    ...
    if skill == "seo-backlinks":
        ...
        recommendations = [
            "Use `.agents/skills/seo/scripts/commoncrawl_graph.py <domain> --json` for free domain-level metrics.",
    ...
    if skill == "seo-drift":
        ...
        recommendations = ["Run `.agents/skills/seo/scripts/drift_baseline.py <url> --skip-cwv` before deployment, then compare after changes."]
