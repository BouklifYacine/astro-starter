...
Usage:
    python .agents/skills/seo/scripts/run_headless_audit.py https://www.python.org --json
    python .agents/skills/seo/scripts/run_headless_audit.py https://www.python.org --output-root output/custom --json
"""
