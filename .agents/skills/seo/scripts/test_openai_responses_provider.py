...
Usage:
    python .agents/skills/seo/scripts/test_openai_responses_provider.py \
...
DEFAULT_TOOL_COMMAND = "python .agents/skills/seo/scripts/run_skill_workflow.py --skill seo-page https://www.python.org --json"
