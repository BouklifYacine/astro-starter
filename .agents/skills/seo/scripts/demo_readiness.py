...
Usage:
    python .agents/skills/seo/scripts/demo_readiness.py --target https://example.com --json
    python .agents/skills/seo/scripts/demo_readiness.py --target https://example.com --live-apis --workflows --json
    python .agents/skills/seo/scripts/demo_readiness.py --target https://example.com --live-apis --live-serp --json
"""
