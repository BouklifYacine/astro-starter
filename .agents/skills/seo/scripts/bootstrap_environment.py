...
Usage:
    python .agents/skills/seo/scripts/bootstrap_environment.py --json
    python .agents/skills/seo/scripts/bootstrap_environment.py --venv .codex-seo-venv --json
    python .agents/skills/seo/scripts/bootstrap_environment.py --skip-playwright-browser --json
"""
