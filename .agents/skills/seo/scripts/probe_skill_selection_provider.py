...
def build_prompt(request: str) -> str:
    ...
    return (
        ...
        "\"python .agents/skills/seo/scripts/run_skill_workflow.py --skill <skill-name> <url> --json\" "
        "for individual skills and "
        "\"python .agents/skills/seo/scripts/run_headless_audit.py <url> --json\" "
...
def validate_repo_command(command: str) -> list[str]:
    ...
    if script == ".agents/skills/seo/scripts/run_skill_workflow.py":
    ...
    if script == ".agents/skills/seo/scripts/run_headless_audit.py":
