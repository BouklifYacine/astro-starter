...
```
python .agents/skills/seo/scripts/dataforseo_costs.py check <endpoint> [--count N]
```
...
```
python .agents/skills/seo/scripts/dataforseo_costs.py log <endpoint> <actual_cost>
```
